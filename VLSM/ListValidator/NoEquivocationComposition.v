...
Context
  ...
  (Free := @free_composite_vlsm _ _ idec IM_index i0)
  (composite_has_been_sent_capability : has_been_sent_capability Free := composite_has_been_sent_capability IM_index i0 (free_constraint IM_index) Hfinite has_been_sent_capabilities)
  (X := composite_vlsm IM_index i0 (no_equivocations Free))
